...
INSERT INTO public.t_applicant
("name", sex, date_of_birth, uin, employment_status, relationship, household_id, is_deleted, created_by, created_date, last_modified_by, last_modified_date, "version")
VALUES('Michelle', 'FEMALE', '2016-02-01', 'S9127893F', 'UNEMPLOYED', 'DAUGHTER', (SELECT id FROM public.t_applicant ta where ta.uin = 'S6336574B'), false, 'SYSTEM', now(), 'SYSTEM',now(), 1);
INSERT INTO public.t_applicant
("name", sex, date_of_birth, uin, employment_status, relationship, household_id, is_deleted, created_by, created_date, last_modified_by, last_modified_date, "version")
VALUES('Ivan', 'MALE', '2018-03-15', 'S5094134E', 'UNEMPLOYED', 'SON', (SELECT id FROM public.t_applicant ta where ta.uin = 'S6336574B'), false, 'SYSTEM', now(), 'SYSTEM', now(), 1);
INSERT INTO public.t_applicant
("name", sex, date_of_birth, uin, employment_status, relationship, household_id, is_deleted, created_by, created_date, last_modified_by, last_modified_date, "version")
